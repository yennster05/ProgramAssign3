...
// in simulator we redefine to format for ProgrammingAssignment3 Developer console
...
{\
	NSString * exceptionName = [@"org.programmingassignment3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.programmingassignment3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIProgrammingAssignment3NativeItemNone = -1, 
	UIProgrammingAssignment3NativeItemSpinner = -2,
	UIProgrammingAssignment3NativeItemProgressBar = -3,
	
	UIProgrammingAssignment3NativeItemSlider = -4,
	UIProgrammingAssignment3NativeItemSwitch = -5,
	UIProgrammingAssignment3NativeItemMultiButton = -6,
	UIProgrammingAssignment3NativeItemSegmented = -7,
	
	UIProgrammingAssignment3NativeItemTextView = -8,
	UIProgrammingAssignment3NativeItemTextField = -9,
	UIProgrammingAssignment3NativeItemSearchBar = -10,
	
	UIProgrammingAssignment3NativeItemPicker = -11,
	UIProgrammingAssignment3NativeItemDatePicker = -12,
	
	UIProgrammingAssignment3NativeItemInfoLight = -13,
	UIProgrammingAssignment3NativeItemInfoDark = -14,
	
	UIProgrammingAssignment3NativeItemDisclosure = -15,
	
	UIProgrammingAssignment3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ProgrammingAssignment3 instances of
