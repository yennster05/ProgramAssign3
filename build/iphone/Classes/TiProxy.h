...
//Rare exceptions to indicate a bug in the _programmingassignment3 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for ProgrammingAssignment3 proxies.
 */
