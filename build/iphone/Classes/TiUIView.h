...
/**
 Base class for all ProgrammingAssignment3 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the ProgrammingAssignment3 view hierarchy (such as wrapped iOS UIViews) was touched.
