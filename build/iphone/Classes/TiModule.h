...
/**
 The base class for all ProgrammingAssignment3 modules
 */
...
/**
 ProgrammingAssignment3 Platform calls this method on startup.
 */
-(void)startup;

/**
 ProgrammingAssignment3 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 ProgrammingAssignment3 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 ProgrammingAssignment3 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 ProgrammingAssignment3 Platform calls this method on resume.
 @param sender The sender of the event.
 */
