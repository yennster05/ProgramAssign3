...
//@interface ProgrammingAssignment3Object : NSObject
//@end

@interface ProgrammingAssignment3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ProgrammingAssignment3Object class]])
		{
			for (NSString *key in [[(ProgrammingAssignment3Object*)o modules] allKeys])
			{
