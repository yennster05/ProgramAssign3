...
@interface ProgrammingAssignment3Object : KrollCoverageObject {
#else
@interface ProgrammingAssignment3Object : KrollObject {
#endif
@private
...
extern NSString * ProgrammingAssignment3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	ProgrammingAssignment3Object *_programmingassignment3;
    KrollObject* console;
	BOOL shutdown;
